About the data set
********************
This data set has 10K labeled product pairs from the Electronics domain. Each pair (prod1, prod2) consists of products from two vendors. Out of the 10K pairs, 5067 are matching pairs and 4933 are non-matching pairs. Below is the format in which the file is organized:
