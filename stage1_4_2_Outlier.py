...
def getList():
    ...
    for line in f:
        ...
        if type in json1:
            ...
            if search in json1:
                ...
                if type1 in hardDrive_map:
                    hardDrive_map[type1] += 1 
                else:
                    hardDrive_map[type1] = 1
        ...
        if type in json2:
            ...
            if search in json2:
                if type2 in hardDrive_map:
                    hardDrive_map[type2] += 1 
                else:
                    hardDrive_map[type2] = 1
    ...
    sorted_list2 = sorted(hardDrive_map.items(), key=lambda d: d[1], reverse=True)
...
def outlier():
    ...
    type = u'Product Type'
    outlierType = u'Desktop Computers' #find outlier within same product type
    outlierSearch = u'Hard Drive Capacity'     #search criteria
    assembledLength_map = {}
